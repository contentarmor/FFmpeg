...
├── ffmpeg-4.2.tar.xz   : the FFmpeg source code used to generate FFmpeg shared libraries used by some ContentArmor softwares
...
By default build.sh compile FFmpeg source with g++ and provide a debian package named libffmpeg4.2-ca_<PACKAGE_VERSION>
